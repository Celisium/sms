...
/* 80052E3C 0004FD7C  C0 22 85 18 */	lfs f1, "@425"@sda21(r2)
...
/* 80052E50 0004FD90  C0 22 85 1C */	lfs f1, "@426"@sda21(r2)
...
/* 80052F5C 0004FE9C  C0 22 85 18 */	lfs f1, "@425"@sda21(r2)
...
/* 80052F9C 0004FEDC  C0 02 85 18 */	lfs f0, "@425"@sda21(r2)
...
/* 80053044 0004FF84  C3 E2 85 1C */	lfs f31, "@426"@sda21(r2)
...
/* 800530F8 00050038  C3 E2 85 1C */	lfs f31, "@426"@sda21(r2)
...
/* 800531AC 000500EC  C3 C2 85 18 */	lfs f30, "@425"@sda21(r2)
/* 800531B0 000500F0  3B 00 00 00 */	li r24, 0
/* 800531B4 000500F4  C3 E2 85 20 */	lfs f31, "@504"@sda21(r2)
...
/* 8005321C 0005015C  C0 22 85 20 */	lfs f1, "@504"@sda21(r2)
/* 80053220 00050160  C0 02 85 1C */	lfs f0, "@426"@sda21(r2)
...
lbl_80053238:
/* 80053238 00050178  C0 02 85 18 */	lfs f0, "@425"@sda21(r2)
...
/* 800540D8 00051018  C0 22 85 1C */	lfs f1, "@426"@sda21(r2)
/* 800540DC 0005101C  1C 00 14 00 */	mulli r0, r0, 0x1400
/* 800540E0 00051020  C0 02 85 20 */	lfs f0, "@504"@sda21(r2)
...
/* 80054754 00051694  C3 C2 85 1C */	lfs f30, "@426"@sda21(r2)
...
/* 8005476C 000516AC  C0 02 85 20 */	lfs f0, "@504"@sda21(r2)
...
/* 8005477C 000516BC  C0 02 85 24 */	lfs f0, "@988"@sda21(r2)
...
/* 80054790 000516D0  C0 02 85 24 */	lfs f0, "@988"@sda21(r2)
/* 80054794 000516D4  C3 E2 85 1C */	lfs f31, "@426"@sda21(r2)
...
lbl_800547DC:
/* 800547DC 0005171C  C0 22 85 28 */	lfs f1, "@989"@sda21(r2)
...
/* 80054814 00051754  C0 22 85 28 */	lfs f1, "@989"@sda21(r2)
...
/* 80054858 00051798  C8 22 85 30 */	lfd f1, "@992"@sda21(r2)
...
/* 800548A4 000517E4  C8 22 85 30 */	lfd f1, "@992"@sda21(r2)
...
/* 800548F8 00051838  C8 22 85 38 */	lfd f1, "@996"@sda21(r2)
...
/* 80054950 00051890  C8 22 85 38 */	lfd f1, "@996"@sda21(r2)
...
/* 80054A80 000519C0  3C A0 80 3E */	lis r5, "@531"@ha
/* 80054A84 000519C4  38 84 4A A0 */	addi r4, r4, __dt__Q38JASystem6Kernel10TSolidHeapFv@l
/* 80054A88 000519C8  38 A5 62 F0 */	addi r5, r5, "@531"@l
